...
public class Constants {
    ...
    public static final String[] SCOPES = {"openid", "Mail.ReadWrite","mail.send","Files.ReadWrite","User.ReadBasic.All", "Calendars.ReadWrite","Group.ReadWrite.All", "User.ReadWrite.All", "Directory.ReadWrite.All"};
}
